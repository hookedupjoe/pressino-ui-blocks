...
PressinoUI.addAttributes('text', tmpAttributes, ['parenticonname','parenticontype','parentbullettype','parentbulletcolor','parentbulletsize','parentbulletalign','header','description']);
