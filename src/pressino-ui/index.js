...
function getSelectControl(theProps, theName, theLabel, theValue, theOnChange, theControlType) {
	...
	var tmpOptions = getSelectionListForField(theControlType);
...
function getSelectionListForField(thePropName){
	if( listSources[thePropName] ){
		return getListAsObjects(listSources[thePropName]);
	}
	return {}
}
...
export const listSources = {
    "color": "Default|,Red|red,Orange|orange,Yellow|yellow,Olive|olive,Green|green,Teal|teal,Blue|blue,Violet|violet,Purple|purple,Pink|pink,Brown|brown,Black|black",
